 ...
 */
object BytesListFeatureEncoder extends FeatureEncoder[String] {
  override def encode(value: String): Feature = {
    val byteList = BytesList.newBuilder().addValue(ByteString.copyFrom(value.getBytes)).build()
